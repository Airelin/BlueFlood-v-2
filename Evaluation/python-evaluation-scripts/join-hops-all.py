...
def export_bar_example(config, export_dir):
    ...
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","Join-hops","default","small-y", 5.0, 8.0)) + ".pdf", format="pdf")

    fig.set_size_inches(4.0, 4.0)
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","join-hops","default","small-y", 4.0, 4.0)) + ".pdf", format="pdf")
