...
def export_bar_example(config, export_dir):
    ...
    data_a = []
    with open('../Logs/Default_20210923_run3/5369_default-old-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_a:
    ...
    data_b = []
    with open('../Logs/Default_20210923_run3/5370_default-old-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_b:
    ...
    data_c = [] 
    with open('../Logs/Default_20210923_run3/5367_default-old-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_c:
    ...
    data_d = []
    with open('../Logs/Default_20210923_run3/5368_default-old-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_d:
    ...
    with open('../Logs/Default_20210923_run2/5353_default-old-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_a1:
    ...
    with open('../Logs/Default_20210923_run2/5354_default-old-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_b1:
    ...
    with open('../Logs/Default_20210923_run2/5351_default-old-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_c1:
    ...
    with open('../Logs/Default_20210923_run2/5352_default-old-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_d1:
    ...
    with open('../Logs/Default_20210923/5313_default-old-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_a2:
    ...
    with open('../Logs/Default_20210923/5314_default-old-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_b2:
    ...
    with open('../Logs/Default_20210923/5311_default-old-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_c2:
    ...
    with open('../Logs/Default_20210923/5312_default-old-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_d2:
    ...
    ############################ New blueflood data ###########################################
    data_e = []
    with open('../Logs/Default_20210923_run3/5373_default-new-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_e:
    ...
    data_f = []
    with open('../Logs/Default_20210923_run3/5374_default-new-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_f:
    ...
    data_g = [] 
    with open('../Logs/Default_20210923_run3/5371_default-new-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_g:
    ...
    data_h = []
    with open('../Logs/Default_20210923_run3/5372_default-new-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_h:
    ...
    with open('../Logs/Default_20210923_run2/5357_default-new-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_e1:
    ...
    with open('../Logs/Default_20210923_run2/5358_default-new-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_f1:
    ...
    with open('../Logs/Default_20210923_run2/5355_default-new-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_g1:
    ...
    with open('../Logs/Default_20210923_run2/5356_default-new-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_h1:
    ...
    with open('../Logs/Default_20210923/5317_default-new-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_e2:
    ...
    with open('../Logs/Default_20210923/5318_default-new-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_f2:
    ...
    with open('../Logs/Default_20210923/5315_default-new-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_g2:
    ...
    with open('../Logs/Default_20210923/5316_default-new-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_h2:
    ...
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","Latency","all-runs","Bar", 5.0, 8.0)) + ".pdf", format="pdf")

    fig.set_size_inches(4.0, 4.0)
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","Latency","all-runs","Bar", 4.0, 4.0)) + ".pdf", format="pdf")
    plt.close()
