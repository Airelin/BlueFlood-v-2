...
def export_bar_example(config, export_dir):
    ...
    data_a = []
    with open('../Logs/Round-nr_Fixed/5305_round_fixed-old-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_a:
    ...
    data_b = []
    with open('../Logs/Round-nr_Fixed/5306_round_fixed-old-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_b:
    ...
    data_c = [] 
    with open('../Logs/Round-nr_Fixed/5303_round_fixed-old-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_c:
    ...
    data_d = []
    with open('../Logs/Round-nr_Fixed/5304_round_fixed-old-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_d:
    ...
    with open('../Logs/Round-nr_Fixed_run2/5361_round_fixed-old-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_a1:
    ...
    with open('../Logs/Round-nr_Fixed_run2/5362_round_fixed-old-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_b1:
    ...
    with open('../Logs/Round-nr_Fixed_run2/5359_round_fixed-old-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_c1:
    ...
    with open('../Logs/Round-nr_Fixed_run2/5360_round_fixed-old-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_d1:
    ...
    ############################ New blueflood data ###########################################
    data_e = []
    with open('../Logs/Round-nr_Fixed/5309_round_fixed-new-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_e:
    ...
    data_f = []
    with open('../Logs/Round-nr_Fixed/5310_round_fixed-new-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_f:
    ...
    data_g = [] 
    with open('../Logs/Round-nr_Fixed/5307_round_fixed-new-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_g:
    ...
    data_h = []
    with open('../Logs/Round-nr_Fixed/5308_round_fixed-new-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_h:
    ...
    with open('../Logs/Round-nr_Fixed_run2/5365_round_fixed-new-blueflood-mode5/logs/latency.txt', encoding="iso-8859-14") as file_e1:
    ...
    with open('../Logs/Round-nr_Fixed_run2/5366_round_fixed-new-blueflood-mode6/logs/latency.txt', encoding="iso-8859-14") as file_f1:
    ...
    with open('../Logs/Round-nr_Fixed_run2/5363_round_fixed-new-blueflood-mode3/logs/latency.txt', encoding="iso-8859-14") as file_g1:
    ...
    with open('../Logs/Round-nr_Fixed_run2/5364_round_fixed-new-blueflood-mode4/logs/latency.txt', encoding="iso-8859-14") as file_h1:
    ...
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","Latency","channel","Bar", 5.0, 8.0)) + ".pdf", format="pdf")

    fig.set_size_inches(4.0, 4.0)
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","Latency","channel","Bar", 4.0, 4.0)) + ".pdf", format="pdf")
    plt.close()
