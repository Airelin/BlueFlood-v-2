...
def export_bar_example(config, export_dir):
    ...
    data_a = []
    with open('../Logs/5217_old-blueflood-mode5/logs/radio-on.txt', encoding="iso-8859-14") as file_a:
    ...
    data_b = []
    with open('../Logs/5218_old-blueflood-mode6/logs/radio-on.txt', encoding="iso-8859-14") as file_b:
    ...
    data_c = [] 
    with open('../Logs/5215_old-blueflood-mode3/logs/radio-on.txt', encoding="iso-8859-14") as file_c:
    ...
    data_d = []
    with open('../Logs/5216_old-blueflood-mode4/logs/radio-on.txt', encoding="iso-8859-14") as file_d:
    ...
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210921","radio-on","old-blueflood","Bar", 5.0, 8.0)) + ".pdf", format="pdf")

    fig.set_size_inches(4.0, 4.0)
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210921","radio-on","old-blueflood","Bar", 4.0, 4.0)) + ".pdf", format="pdf")
