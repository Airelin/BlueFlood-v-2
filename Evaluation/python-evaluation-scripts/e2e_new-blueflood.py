...
def export_bar_example(config, export_dir):
    ...
    data_a = []
    with open('../Logs/5213_blueflood2-mode5/logs/e2e-join.txt', encoding="iso-8859-14") as file_a:
    ...
    data_b = []
    with open('../Logs/5214_blueflood2-mode6/logs/e2e-join.txt', encoding="iso-8859-14") as file_b:
    ...
    data_c = [] 
    with open('../Logs/5211_blueflood2-mode3/logs/e2e-join.txt', encoding="iso-8859-14") as file_c:
    ...
    data_d = []
    with open('../Logs/5212_blueflood2-mode4/logs/e2e-join.txt', encoding="iso-8859-14") as file_d:
    ...
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210921","e2e","new-blueflood","Bar", 5.0, 8.0)) + ".pdf", format="pdf")

    fig.set_size_inches(4.0, 4.0)
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210921","e2e","new-blueflood","Bar", 4.0, 4.0)) + ".pdf", format="pdf")
