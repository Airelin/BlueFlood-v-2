...
def export_bar_example(config, export_dir):
    ...
    data_a = []
    with open('../Logs/One_channel/5321_one_channel-old-blueflood-mode5/logs/e2e-join.txt', encoding="iso-8859-14") as file_a:
    ...
    data_b = []
    with open('../Logs/One_channel/5322_one_channel-old-blueflood-mode6/logs/e2e-join.txt', encoding="iso-8859-14") as file_b:
    ...
    data_c = [] 
    with open('../Logs/One_channel/5319_one_channel-old-blueflood-mode3/logs/e2e-join.txt', encoding="iso-8859-14") as file_c:
    ...
    data_d = []
    with open('../Logs/One_channel/5320_one_channel-old-blueflood-mode4/logs/e2e-join.txt', encoding="iso-8859-14") as file_d:
    ...
    ############################ New blueflood data ###########################################
    data_e = []
    with open('../Logs/One_channel/5325_one_channel-new-blueflood-mode5/logs/e2e-join.txt', encoding="iso-8859-14") as file_e:
    ...
    data_f = []
    with open('../Logs/One_channel/5326_one_channel-new-blueflood-mode6/logs/e2e-join.txt', encoding="iso-8859-14") as file_f:
    ...
    data_g = [] 
    with open('../Logs/One_channel/5323_one_channel-new-blueflood-mode3/logs/e2e-join.txt', encoding="iso-8859-14") as file_g:
    ...
    data_h = []
    with open('../Logs/One_channel/5324_one_channel-new-blueflood-mode4/logs/e2e-join.txt', encoding="iso-8859-14") as file_h:
    ...
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","E2E","channel","Bar", 5.0, 8.0)) + ".pdf", format="pdf")

    fig.set_size_inches(4.0, 4.0)
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","E2E","channel","Bar", 4.0, 4.0)) + ".pdf", format="pdf")
