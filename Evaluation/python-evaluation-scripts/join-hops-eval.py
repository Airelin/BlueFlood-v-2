...
def export_bar_example(config, export_dir):
    ...
    ############################ New blueflood data ###########################################
    data_e = []
    with open('../Logs/Default_20210923_run3/5373_default-new-blueflood-mode5/logs/join-hops.txt', encoding="iso-8859-14") as file_e:
    ...
    data_f = []
    with open('../Logs/Default_20210923_run3/5374_default-new-blueflood-mode6/logs/join-hops.txt', encoding="iso-8859-14") as file_f:
    ...
    data_g = [] 
    with open('../Logs/Default_20210923_run3/5371_default-new-blueflood-mode3/logs/join-hops.txt', encoding="iso-8859-14") as file_g:
    ...
    data_h = []
    with open('../Logs/Default_20210923_run3/5372_default-new-blueflood-mode4/logs/join-hops.txt', encoding="iso-8859-14") as file_h:
    ...
    with open('../Logs/Default_20210923_run2/5357_default-new-blueflood-mode5/logs/join-hops.txt', encoding="iso-8859-14") as file_e1:
    ...
    with open('../Logs/Default_20210923_run2/5358_default-new-blueflood-mode6/logs/join-hops.txt', encoding="iso-8859-14") as file_f1:
    ...
    with open('../Logs/Default_20210923_run2/5355_default-new-blueflood-mode3/logs/join-hops.txt', encoding="iso-8859-14") as file_g1:
    ...
    with open('../Logs/Default_20210923_run2/5356_default-new-blueflood-mode4/logs/join-hops.txt', encoding="iso-8859-14") as file_h1:
    ...
    with open('../Logs/Default_20210923/5317_default-new-blueflood-mode5/logs/join-hops.txt', encoding="iso-8859-14") as file_e2:
    ...
    with open('../Logs/Default_20210923/5318_default-new-blueflood-mode6/logs/join-hops.txt', encoding="iso-8859-14") as file_f2:
    ...
    with open('../Logs/Default_20210923/5315_default-new-blueflood-mode3/logs/join-hops.txt', encoding="iso-8859-14") as file_g2:
    ...
    with open('../Logs/Default_20210923/5316_default-new-blueflood-mode4/logs/join-hops.txt', encoding="iso-8859-14") as file_h2:
    ...
    ax.yaxis.grid(True)
    plt.ylabel("Joining tempo in number of rounds")
    ...
    plt.axis([None, None, 0, 650])

    # Adapt the figure size as needed
    fig.set_size_inches(5.0, 8.0)
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","Join-hops","default","Bar", 5.0, 8.0)) + ".pdf", format="pdf")

    fig.set_size_inches(4.0, 4.0)
    plt.tight_layout()
    plt.savefig(export_dir + slugify(("20210924","join-hops","default","Bar", 4.0, 4.0)) + ".pdf", format="pdf")
